...
def create_question(question_text, days):
    ...
    numbers of 'days' offset to now (negative for question published in the 
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        Question with a pub_date in the future are not displayed on the index 
        page.
        """
    ...
    def test_future_question_and_past_question(self):
        """
        Even if both past and future question exist, only past question are 
        displayed.
        """
        create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        The detail view of a question with pub_date in the past displays the 
        question's text.
        """
